# test.ps1 — Shakespeare TTS demo: Othello, Act III Scene III
#
# Test 1 — Narrator:  Aiden (clear American male), no instruct
# Test 2 — Othello:   Ryan  (dynamic English male), jealousy & rage
# Test 3 — Desdemona: Sohee (warm Korean female),  love & joy
#
# Usage: .\test.ps1
...
# ---------------------------------------------------------------------------
# Test 1 — Narrator (Aiden, no instruct)
# ---------------------------------------------------------------------------
Write-Host ""
...
# ---------------------------------------------------------------------------
# Test 2 — Othello (Ryan, extreme negative)
# ---------------------------------------------------------------------------
Write-Host ""
...
"@ -Speaker "Ryan" -Instruct "A deep, resonant male voice breaking apart with overwhelming grief and volcanic rage — trembling with jealousy, barely containing explosive fury, each word torn from a soul in agony"

# ---------------------------------------------------------------------------
# Test 3 — Desdemona (Sohee, extreme positive)
# ---------------------------------------------------------------------------
Write-Host ""
Write-Host "=== TEST 3 / 3  |  Desdemona — Love & Joy ===" -ForegroundColor Green
...
"@ -Speaker "Sohee" -Instruct "A warm, luminous young female voice overflowing with radiant joy, breathless adoration, and pure happiness — glowing with total devotion, every word lit from within by love"
